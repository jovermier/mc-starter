...
export type Scalars = {
  ...
  bytea: { input: Uint8Array; output: Uint8Array };
  citext: { input: string; output: string };
  jsonb: { input: jsonb; output: jsonb };
  timestamp: { input: string | Date; output: string | Date };
  timestamptz: { input: string | Date; output: string | Date };
...
export type TestQuery = { __typename: 'query_root' };
